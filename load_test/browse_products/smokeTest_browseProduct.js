...
export const options = {
  ...
  duration: '15s',
  thresholds: {
    'http_reqs{group:::smokeTest}': ['rate>=5'],               //Set thresholds metrics for Throughput
    'http_req_duration{group:::smokeTest}': ['p(95)<400'],     //Set thresholds metrics for Response Time
