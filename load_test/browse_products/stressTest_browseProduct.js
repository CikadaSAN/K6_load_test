...
export const options = {
  ...
  thresholds: {
    'http_reqs{group:::stressTest}': ['rate>=5'],               //Set thresholds metrics for Throughput
    'http_req_duration{group:::stressTest}': ['p(95)<400'],     //Set thresholds metrics for Response Time
